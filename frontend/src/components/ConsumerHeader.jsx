      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center gap-4">
          ...
          <Link to="/explore" className="flex items-center gap-2.5 flex-shrink-0">
            ...
            <span className="font-black text-lg text-slate-900 hidden sm:block">BoutiqueKi</span>
          </Link>
              ...
              {searchOpen && (
                ...
                >
                  <input
                    ...
                    className="w-full pl-4 pr-10 py-2 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </motion.form>
              )}
            </AnimatePresence>
              ...
              <AnimatePresence>
                {userMenuOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-full mt-2 w-56 bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden py-1.5"
                  >
                    ...
                    <div className="py-1">
                      <Link to="/client" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                        <LayoutDashboard className="w-4 h-4 text-slate-400" /> Mon espace
                      </Link>
                      <Link to="/client/orders" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                        <Package className="w-4 h-4 text-slate-400" /> Mes commandes
                      </Link>
                      <Link to="/client/claims" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
                        <MessageSquareWarning className="w-4 h-4 text-slate-400" /> Mes reclamations
                      </Link>
                      <Link to="/client/profile" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition-colors">
            ...
            >
              <div className="px-4 py-3 space-y-1">
                ...
                <div className="border-t border-slate-100 pt-2 mt-2">
                  {isAuthenticated ? (
                    <>
                      <Link to="/client" className="block px-4 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-100">Mon espace</Link>
                      <Link to="/client/orders" className="block px-4 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-100">Mes commandes</Link>
                      <Link to="/client/claims" className="block px-4 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-100">Mes reclamations</Link>
                      <Link to="/client/profile" className="block px-4 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-100">Mon profil</Link>
                    ...
                    <>
                      <Link to="/login" className="block px-4 py-2.5 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-100">Connexion</Link>
