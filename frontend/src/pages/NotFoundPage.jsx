...
const NotFoundPage = () => (
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-white px-6">
    ...
    >
      ...
      <h1 className="text-2xl font-black text-slate-900 dark:text-slate-100 mt-2 mb-2">Page introuvable</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Link
          to="/"
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 font-semibold hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
        >
